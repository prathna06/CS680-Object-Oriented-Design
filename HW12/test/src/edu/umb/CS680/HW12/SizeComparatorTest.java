...
class SizeComparatorTest {
    ...
    public void Test_getChildren() {
        ...
        List<FSElement> fse = directory.getChildren(new SizeComparator());
    ...
    public void Test_getFiles() {
        ...
        List<File> file = directory.getFiles(new SizeComparator());
    ...
    public void Test_getSubDirectories() {
        ...
        List<Directory> dir = directory.getSubDirectories(new SizeComparator());
