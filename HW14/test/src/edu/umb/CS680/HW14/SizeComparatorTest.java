...
class SizeComparatorTest {
    ...
    @Test
    public void Test_getChildrenSize() {
        FSElement[] expected = {
        ...
        List<FSElement> fse = directory.getChildren((FSElement o1, FSElement o2) -> o1.getSize()-o2.getSize());
        assertArrayEquals(expected,fse.toArray() );
    }

    @Test
    public void Test_getFilesSize() {
        ...
        List<File> file = directory.getFiles((FSElement o1, FSElement o2) -> o1.getSize()-o2.getSize());
        assertArrayEquals(expected,file.toArray());
    }

    @Test
    public void Test_getSubDirectoriesSize() {
        ...
        List<Directory> dir = directory.getSubDirectories((FSElement o1, FSElement o2) -> o1.getSize()-o2.getSize());
